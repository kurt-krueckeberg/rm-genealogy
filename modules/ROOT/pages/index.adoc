= Overview of Genealoy Software Schemas 
...
Much of the database information for Roots Magoc came from https://sqlitetoolsforrootsmagic.com[SQLite Tools for RootsMagic].
