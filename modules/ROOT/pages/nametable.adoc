...
A person in the Persons table may have more than one associated name. `NameTable.OwnerID` is a foreign key refering to Persons.occurs more than once in `NameTable`.
