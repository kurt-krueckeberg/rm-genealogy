CREATE TABLE person (id VARCHAR(50) PRIMARY KEY NOT NULL,
	 given_name TEXT,
	 surname TEXT,
	 blob_data BLOB,
	 gramps_id TEXT,
...
CREATE TABLE family (id VARCHAR(50) PRIMARY KEY NOT NULL,
	 blob_data BLOB,
	 gramps_id TEXT,
...
CREATE TABLE source (id VARCHAR(50) PRIMARY KEY NOT NULL,
	 blob_data BLOB,
	 gramps_id TEXT,
	 title TEXT,
	 author TEXT,
...
CREATE TABLE citation (id VARCHAR(50) PRIMARY KEY NOT NULL,
	 blob_data BLOB,
	 gramps_id TEXT,
	 page TEXT,
	 confidence INTEGER,
...
CREATE TABLE event (id VARCHAR(50) PRIMARY KEY NOT NULL,
	 blob_data BLOB,
	 gramps_id TEXT,
	 description TEXT,
	 place VARCHAR(50),
...
CREATE TABLE media (id VARCHAR(50) PRIMARY KEY NOT NULL,
	 blob_data BLOB,
	 gramps_id TEXT,
	 path TEXT,
	 mime TEXT,
...
CREATE TABLE place (id VARCHAR(50) PRIMARY KEY NOT NULL,
...
CREATE TABLE repository (id VARCHAR(50) PRIMARY KEY NOT NULL,
	 blob_data BLOB,
	 gramps_id TEXT,
	 name TEXT,
	 change INTEGER,
...
CREATE TABLE note (id VARCHAR(50) PRIMARY KEY NOT NULL,
	 blob_data BLOB,
	 gramps_id TEXT,
	 format INTEGER,
	 change INTEGER,
...
CREATE TABLE tag (id VARCHAR(50) PRIMARY KEY NOT NULL,
	 blob_data BLOB,
	 name TEXT,
	 color VARCHAR(13),
	 priority INTEGER,
...
CREATE TABLE reference (obj_id VARCHAR(50),
	 obj_class TEXT,
	 ref_id VARCHAR(50),
	 ref_class TEXT);
...
CREATE INDEX reference_ref_id ON reference(ref_id);
...
CREATE INDEX reference_obj_id ON reference(obj_id);
